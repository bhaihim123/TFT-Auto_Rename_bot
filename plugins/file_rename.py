...
async def auto_rename_files(client, message):
    ...
    media_preference = await TFTBOTS.get_media_preference(user_id)
    ...
    try:
        ...
        ph_path = None
        c_caption = await TFTBOTS.get_caption(message.chat.id)
        c_thumb = await TFTBOTS.get_thumbnail(message.chat.id)
